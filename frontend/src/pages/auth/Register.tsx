...
import {
  ...
  FileText, MapPin, Camera, Shield, Upload, ChevronRight, Check,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          {([
            { value:'CLIENT', icon:'🛒', title:'Sou Cliente', desc:'Quero comprar peças prontas ou solicitar orçamentos personalizados' },
            { value:'MAKER',  icon:'🖨️', title:'Sou Maker',  desc:'Tenho impressoras 3D e quero vender meus produtos e serviços' },
  ...
  if (step === 3) return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={infoForm.handleSubmit(() => setStep(4))} className="glass rounded-2xl p-6 border border-white/10 space-y-4">
          {entityType === 'PF' ? (
            <>
          ...
          <div className="relative">
            <Input label="Senha *" type={showPass ? 'text' : 'password'} placeholder="Mínimo 6 caracteres" icon={<Lock size={16} />}
  ...
  if (step === 4) return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={addrForm.handleSubmit(role === 'MAKER' ? () => setStep(5) : doRegister)}
        ...
        <div className="glass rounded-2xl p-6 border border-white/10 space-y-5">
          <div className="glass rounded-xl p-4 border border-neon-blue/20 flex gap-3">
            ...
            <p className="text-sm text-gray-400">
              Seus documentos são analisados em até <strong className="text-white">48 horas</strong>.
              Enquanto isso, sua conta fica com acesso limitado. Você pode enviar depois pelo painel.
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <Button type="button" className="flex-1" loading={submitting} disabled={!kycAgreed}
          ...
          <button type="button" disabled={submitting}
            ...
            onClick={() => addrForm.handleSubmit(doRegister)()}>
            Pular verificação — enviar documentos depois
          </button>
        </div>
      </div>
    </div>
